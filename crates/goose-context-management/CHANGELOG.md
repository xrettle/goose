...
- a lean ACP-only Goose binary ([#11961](https://github.com/aaif-goose/goose/pull/11961))

### Fixed

- fix context management dependency ([#11768](https://github.com/aaif-goose/goose/pull/11768))
